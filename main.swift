...
//  RSSUpdater
//
//  Created by 홍성준 on 2025/05/06.
//

import Foundation

enum Constants {
  static let blogLink = "https://raw.githubusercontent.com/hogumachu/hogumachu.github.io/refs/heads/production/feed.rss"
...
RSSUpdater().load(url: Constants.blogLink) { contents in
